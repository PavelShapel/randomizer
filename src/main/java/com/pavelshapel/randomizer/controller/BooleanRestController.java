...
@RestController
@RequestMapping("/")
public class BooleanRestController extends AbstractRestController<Boolean> {
    public static final String PATH = "/boolean";

    @LogMethodResult
    @GetMapping(PATH)
    @Override
    protected ResponseEntity<RandomEntity<Boolean>> randomize() {
