...
public class BooleanValueSpecification extends AbstractRangeValueSpecification<Boolean> {
    public BooleanValueSpecification() {
        super(Boolean.class);
    }

    public BooleanValueSpecification(Range<Long> range) {
        super(Boolean.class, range);
    }
