...
class StringCollectionRandomizerTest {
    private final StringCollectionRandomizer stringCollectionRandomizer;

    @Autowired
    StringCollectionRandomizerTest(StringCollectionRandomizer stringCollectionRandomizer) {
        this.stringCollectionRandomizer = stringCollectionRandomizer;
    }

    @Test
    void randomize_WithDefaultRange_ShouldReturnCollection() {
        final Collection<String> randomCollection = stringCollectionRandomizer.randomize();
    ...
    void randomize_WithBoundedRange_ShouldReturnCollection(long min, long max) {
        ...
        final Collection<String> randomCollection = stringCollectionRandomizer.randomize(range);
    ...
    void randomize_NullAsParam_ShouldReturnCollection() {
        final Collection<String> randomCollection = stringCollectionRandomizer.randomize(null);
