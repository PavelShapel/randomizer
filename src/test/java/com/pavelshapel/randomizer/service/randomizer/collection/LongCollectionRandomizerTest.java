...
class LongCollectionRandomizerTest {
    ...
    void randomize_WithDefaultRange_ShouldReturnCollection() {
        final Collection<Long> randomCollection = longCollectionRandomizer.randomize();
    ...
    void randomize_WithBoundedRange_ShouldReturnCollection(long min, long max) {
        ...
        final Collection<Long> randomCollection = longCollectionRandomizer.randomize(range);
    ...
    void randomize_NullAsParam_ShouldReturnCollection() {
        final Collection<Long> randomCollection = longCollectionRandomizer.randomize(null);
