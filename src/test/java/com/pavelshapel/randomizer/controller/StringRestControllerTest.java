...
class StringRestControllerTest extends AbstractRestControllerTest<String> {
    ...
    void getRandomEntity_WithDefaultRange_ShouldReturnRandomEntity() {
        ...
        final RandomEntity<String> randomEntityFromResponse = getRandomEntityFromResponse(mvcResult);
    ...
    @Override
    protected RandomEntity<String> getMockRandomEntity() {
        return new RandomEntity<>("123456", String.class);
    }
}